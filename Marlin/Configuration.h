...
#define DELTA
  ...
  #define DELTA_HEIGHT 398.2 // get this value from auto calibrate
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the boundaries for probing (where the probe can reach).
  #define LEFT_PROBE_BED_POSITION -(DELTA_PROBEABLE_RADIUS) +55
  #define RIGHT_PROBE_BED_POSITION DELTA_PROBEABLE_RADIUS
  #define FRONT_PROBE_BED_POSITION -(DELTA_PROBEABLE_RADIUS) +34
