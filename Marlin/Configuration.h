...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode.
    ...
    #define LEFT_PROBE_BED_POSITION -DELTA_PROBABLE_RADIUS + 55
    #define RIGHT_PROBE_BED_POSITION DELTA_PROBABLE_RADIUS
    #define FRONT_PROBE_BED_POSITION -DELTA_PROBABLE_RADIUS + 34
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 55     // Z probe to nozzle X offset: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 34   // Z probe to nozzle Y offset: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -4.7  // Z probe to nozzle Z offset: -below (always!)
  ...
  #define Z_RAISE_BEFORE_PROBING 50   // How much the Z axis will be raised before traveling to the first probing point.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 160, 760*1.75}  // default steps per unit for Kossel (GT2, 20 tooth)
