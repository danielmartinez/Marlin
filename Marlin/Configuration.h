...
#define MANUAL_Z_HOME_POS 392 // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {40, 40, 40, 760*1.1}  // default steps per unit for Kossel (GT2, 20 tooth)
