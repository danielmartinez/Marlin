 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 160, 4000, 765 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 2.75, 25 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -6.30   // Z offset: -below +above  [the nozzle]
