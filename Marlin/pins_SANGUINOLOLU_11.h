...
#define HEATER_2_PIN       -1
  ...
  #define Z_ENABLE_PIN       14 // Was 26, board customization for z-probe on 26
...
//#define SDSS               24
   ...
   #define BTN_EN1 10 // Switched from 11 in order to change dir
   #define BTN_EN2 11 // Switched from 10 "
   #ifdef LCD_I2C_PANELOLU2
     #if MB(MELZI)
